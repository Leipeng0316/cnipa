...
(function () {
    ...
    // 全部字段（顺序）
    var ALL_HEADERS = ['专利号','专利名称','专利类型','申请人','案件状态','费用种类','应缴金额','截止日期','代理所','质押状态','授权公告日','法律状态','费用状态','最近缴费人','最近缴费种类','变更费','质押信息','许可备案信息'];
    // 默认显示字段
    var DEFAULT_HEADERS = ['专利号','专利名称','专利类型','申请人','案件状态','应缴金额','截止日期','代理所','质押状态'];
